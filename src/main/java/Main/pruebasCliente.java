...
//import Negocio.AnalisisClienteNegocio;
...
//            AnalisisClienteNegocio negocioAnalisis = new AnalisisClienteNegocio(acDTO);
//            //LOCALDATETIME.NOW PARA CAPTURAR DATOS 
//            AnalisisClienteEntidad analisisE = new AnalisisClienteEntidad(LocalDateTime.now(), 13);
//            AnalisisClienteDTO analisiscliente = negocioAnalisis.generarAnalisisCliente(analisisE);
//            
//            System.out.println("Analisis del Cliente es: "+analisiscliente.toString());
//            
//            
//                    
//
...
//            
//            List<TablaClienteDTO> clientes = clienteNegocio.buscarClientesPorLaboratorio(3);
